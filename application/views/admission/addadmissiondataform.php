...
<div class="container-fluid">
   ...
   <div class="row">             
     <div class="col-sm-6">
           ...
           <div style="margin-bottom:17px;">
                <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Prénom</div>   
                </div>
        ...
        <div class="text-danger text-center"><?php echo form_error('e_patientmname'); ?></div>
          ...
          <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Nom</div>   
                </div>
    ...
    <div class="col-sm-6">
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800">
         <select class="form-control" name="su_user">
          <option value="">Select</option>
              <?php if(count($get_user)): ?>
                <?php foreach($get_user as $useraccount): ?>
                  <option value=<?php echo $useraccount->su_id; ?><?php echo set_select('su_user', $useraccount->su_user); ?>><?php echo  "Dr. ".$useraccount->su_user; ?></option>
                        <?php endforeach; ?>
                <?php endif; ?>
         </select>
        </div>
        <div class="text-danger text-center"><?php echo form_error('su_user'); ?></div>
                </div>
       ...
       <div style="margin-bottom:17px;">
        ...
        <div class="text-danger text-center"><?php echo form_error('e_condition'); ?></div>
           ...
           <?php echo "<button style='margin-left: 235px; margin-bottom: 20px; text-decoration:none' type='submit' class='btn btn-primary btn-icon-split' name='submit' href='". base_url() ."admissioncontrol/edit_findings/". $get_admission_view->pr_id ."#findings'>" ?> 
