...
<div style="margin-left: 5px;" class="row">
        ...
        <div class=" no-gutters ">
             ...
             <option value=<?php echo $get_data_admission->ad_physician; ?><?php echo set_select('su_user', $get_data_admission->ad_physician); ?>><?php echo "Dr. ".$get_data_admission->ad_physician; ?></option>
             <?php if(count($get_physician)): ?>
                        <?php foreach($get_physician as $physician): ?>
                        <option value=<?php echo $physician->ph_name.' / '.$physician->ph_fieldofphysician; ?><?php echo set_select('su_user', $physician->ph_name.' / '.$physician->ph_fieldofphysician); ?>><?php echo "Dr. ".$physician->ph_name.' / '.$physician->ph_fieldofphysician; ?></option>
               <?php endforeach; ?>
             <?php endif; ?> 
            </select> 
        <div class="text-danger text-center"><?php echo form_error('su_user'); ?></div>
                 ...
                 <button style='margin-left: 230px; margin-top: 50px;' type='submit' class='btn btn-primary ' name='submit'> 
