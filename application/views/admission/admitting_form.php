   ...
   <div class="row">            
    ...
    <div class="row">
       ...
       <input class="form-control <?= (form_error('a_totalpayment') == "" ? '':'is-invalid') ?>" type="text" name="a_totalpayment" placeholder="Enter Total Payment Amount" value="<?php echo set_value('a_totalpayment') ?>">
           ...
           <?php echo "<button style='margin-left: 250px; margin-bottom: 20px; text-decoration:none' type='submit' class='btn btn-primary btn-icon-split' name='submit' href='". base_url() ."admissioncontrol/admit_form/". $get_data->pr_id ."#admission'>" ?> 
