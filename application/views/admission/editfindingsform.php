    ...
    <div class="col-sm-6">
        ...
        <div class="text-danger text-center"><?php echo form_error('e_medical_treatment'); ?></div>
         ...
         <select class="form-control" name="su_user">
            <option value=<?php echo $get_findings_view->f_nameofphysician; ?><?php echo set_select('su_user', $get_findings_view->f_nameofphysician); ?>><?php echo "Dr. ".$get_findings_view->f_nameofphysician; ?></option>
        ...
        <div class="text-danger text-center"><?php echo form_error('su_user'); ?></div>
           ...
           <?php echo "<button style='margin-left: 235px; margin-bottom: 20px; text-decoration:none' type='submit' class='btn btn-primary btn-icon-split' name='submit' href='". base_url() ."admissioncontrol/edit_findings/". $get_findings_view->pr_id ."#findings'>" ?> 
