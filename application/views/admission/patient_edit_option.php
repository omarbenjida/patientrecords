 ...
 <?php $attributes = array('id' => 'edit_option_form', 'class' => 'form-horizontal user'); ?>
               ...
               <div style="margin-bottom:17px;">
                 ...
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Addresse</div>   
                </div>
        ...
        <div class="text-danger text-center"><?php echo form_error('e_date'); ?></div>
           ...
           <button style="margin-left: 100px;" type="submit" class="btn btn-primary btn-icon-split" name="submit">
