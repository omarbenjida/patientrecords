...
<div class="col-sm-3">
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><input class="form-control  <?= (form_error('a_lname') == "" ? '':'is-invalid') ?>" type="text" name="a_lname" placeholder="Enter Nom" value="<?php echo set_value('a_lname'); ?>" ></div>
