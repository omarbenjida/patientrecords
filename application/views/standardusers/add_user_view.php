       <!-- DataTales Example -->
         ...
         <h5 class="mb-2 text-gray-800"> Ajouter Medecins </h5>
        ...
        <?php if($this->session->flashdata('add_user')): ?>  
         ...
         $this->load->view($addform);
          ...
          <div  id="addusertable" class="card shadow mb-4">
            ...
            <!-- Page Heading -->
          <h5 class="mb-2 text-gray-800">Medecins </h5>  
           ...
           <?php endif; ?>
              ...
              <div class="table">
                <table class="table table-bordered " id="dataTable" width="100%" cellspacing="0">
                  ...
                  <thead>
                    <tr>
                      <th class="text-center">Nom D'utilisateur du Medecin</th>
                      <th class="text-center">Nom</th>
                      
                      <th class="text-center">Date Ajouté(e)</th>
                ...
                <?php foreach($get_user as $user): ?>
                 ...
                 <?php echo "<td class='text-center'><a class='btn btn-warning' href='". base_url() ."addusercontrol/edit_user/". $user->su_id ."'>Editer
                  </a>" ?>
                  
                 <?php echo "<a class='btn btn-danger'  href='". base_url() ."addusercontrol/delete_user/". $user->su_id ."' onClick='return doconfirm()' >Supprimer
                  </a>" ?>
                   </td>
