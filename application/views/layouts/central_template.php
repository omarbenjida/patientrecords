...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class=" navbar-nav bg-gradient-info sidenav sidebar sidebar-dark accordion " id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  href="#">
        ...
        <div class="sidebar-brand-text mx-3">ENSAM HOSPITAL</div>
      </a>
       ...
       sa loob ng file name na config.php sa bandang baba makikita yan
        ...
        <?php echo base_url(); ?>
         ...
         -->
          ...
          <span>Table Des Patients</span></a>
      </li>

      <!-- Nav Item - for Insert Multiple Record (link for specific page) -->
      <li class="nav-item active">
         <!-- Nav Item - Tables -->
        <a class="nav-link collapsed " href="<?php echo base_url(); ?>admissioncontrol/opd_form">
          <i class="fas fa-fw fa-list-alt "></i>
          <span>Ajouter Patients</span></a>
      </li>

      <!-- Nav Item - for Ajouter Medecins (link for specific page)-->
      <li class="nav-item active">
         <!-- Nav Item - Tables -->
        <a class="nav-link collapsed " href="<?php echo base_url(); ?>addusercontrol/adduserview">
          <i class="fas fa-fw fa-user-plus "></i>
          <span>Ajouter Medecins</span></a>
      </li>
 ...
 <!-- Bootstrap core JavaScript-->
  ...
  <script src="<?php echo base_url(); ?>assets/vendor/jquery-tabledit/jquery.tabledit.min.js"></script>
