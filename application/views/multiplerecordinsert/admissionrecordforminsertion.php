...
<!--Begin -->
 ...
 <div style="margin-left: 10px; margin-right: 10px;" class="row">
   ...
   <br><br>
           ...
           <?php echo "<button style='margin-left: 410px; margin-bottom: 20px; text-decoration:none' type='submit' class='btn btn-primary btn-icon-split' name='submit' href='". base_url() ."admissioncontrol/admit_form'>" ?> 
