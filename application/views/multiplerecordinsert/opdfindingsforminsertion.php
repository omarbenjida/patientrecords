...
<div class="container-fluid">
   ...
   <div class="row">             
        ...
        <div class="text-danger text-center"><?php echo form_error('a_casenumber'); ?></div>
          ...
          <input class="form-control <?= (form_error('a_historyillness') == "" ? '':'is-invalid') ?>" type="text" name="a_historyillness" value="<?php echo set_value('a_historyillness'); ?>" placeholder="Enter Historique de Maladies"></div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
           ...
           <?php echo "<button style='margin-left: 410px; margin-bottom: 20px; text-decoration:none' type='submit' class='btn btn-primary btn-icon-split' name='submit' href='". base_url() ."multiplerecordcontrol/add_multiple_findings'>" ?> 
