               ...
               <?php echo form_open('indexcontrol/newaccountquestion', $attributes); ?>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control  " name="secquestion">
                    ...
                    <option value="What was your childhood nickname?"<?php echo set_select('secquestion','What was your childhood nickname?', (!empty($data) && $data == "What was your childhood nickname?" ? TRUE : FALSE )); ?>>Quel est votre surnom d'enfance ?</option>
                ...
                <button style="margin-left: 180px;" type="submit" class="btn btn-primary btn-icon-split" name="submit">
