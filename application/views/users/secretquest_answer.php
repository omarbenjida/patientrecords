    ...
    <?php if($this->session->flashdata('forgotpass_success')): ?>
        ...
        <?php if($this->session->flashdata('secretans_failed')): ?>
          ...
          <h1 style="margin-left: 72px;" class="h4 text-gray-900 mb-2 text-center">Question secret</h1> 
               ...
               <?php echo form_open('indexcontrol/forgot_secretquestion/'.$id->u_id.'', $attributes); ?>
                ...
                <button style="margin-left: 149px;" type="submit" class="btn btn-primary btn-icon-split" name="submit">
