        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="text-center">
              ...
              <hr>
              <div class="text-center">
                 <h5 class="h5 text-gray-900 mb-4">Espace d'authentification des médecins </h1>
              </div> 
            ...
            <?php $this->load->view($form); ?>
              ...
              <div class="text-center">
                <a style="color: black; text-decoration: none" class="medium" href="<?php echo base_url(); ?>usercontrol/login">Vous êtes admin?</a>
              </div>
