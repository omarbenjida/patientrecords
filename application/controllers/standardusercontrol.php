...
$this->form_validation->set_rules('e_patientfname','Prénom','required|trim|alpha');
$this->form_validation->set_rules('e_patientmname','Middlename', 'required|trim');
$this->form_validation->set_rules('e_patientlname','Nom', 'required|trim|alpha');
...
$this->form_validation->set_rules('su_user','Username','required', array('required' => 'Please select the username of the doctor!'));
...
$this->load->view('layouts/central_template', $data);
  ...
  $date = date("Y-m-d");
   ...
   'a_physician_id' => $this->input->post('su_user'),
   'a_date' => $date 
...
$data['get_user'] = $this->Record_model->get_users_account($doctor);
  ...
  $date = date("Y-m-d");
   ...
   'of_physician_id' => $this->input->post('su_user'),
   'of_date' => $date 
...
$data['main_view'] = "admission/addadmissiondata";
   ...
   'oad_physician_id' => $this->input->post('su_user'),
   'oad_date' => $date 
