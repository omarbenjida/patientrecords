...
$this->form_validation->set_rules('a_fname', 'Prénom', 'trim|required|alpha');
...
$this->load->view('layouts/central_template', $data);
   ...
   if($this->Addusers_model->add_user($user_id)){
      ...
      $this->session->set_flashdata('add_user', 'Medecin Ajouté(e)');
      $this->load->view('layouts/central_template', $data);
...
$this->form_validation->set_rules('e_fname', 'Prénom', 'trim|required|alpha');
$this->form_validation->set_rules('e_position', 'Position', 'trim');
...
$this->load->view('layouts/central_template', $data);
   ...
   if($this->Addusers_model->edit_user_data($user_id)){
      ...
      $this->session->set_flashdata('edit_user', 'Medecin Ajouté(e)');
...
$this->form_validation->set_rules('a_fname', 'Prénom', 'trim|required|alpha');
$this->form_validation->set_rules('a_lname', 'Nom', 'trim|required|alpha');
