...
$this->form_validation->set_rules('a_historyillness', 'Historique de Maladies', 'required');
  ...
  $date = date("Y-m-d");
   ...
   'f_date' => $this->input->post('a_date')
    ...
    if($this->Multiplerecord_model->patientFinding($data)){
      ...
      $this->session->set_flashdata('add_multiple_findings', 'Analyses MedicalesAdded');
