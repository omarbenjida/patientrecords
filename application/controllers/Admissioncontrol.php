...
$this->form_validation->set_rules('lname', 'Nom', 'trim|required|alpha_numeric_spaces');
$this->form_validation->set_rules('fname', 'Prénom', 'trim|required|alpha_numeric_spaces');
...
$this->form_validation->set_rules('gen', 'gender', 'trim|required',array('required'=>'Sexe Obligatoire'));
$this->form_validation->set_rules('br_place', 'br_place', 'required');
$this->form_validation->set_rules('datebirth', 'Date of Birth', 'trim|required');
$this->form_validation->set_rules('civilstat', 'Statut', 'trim|required');
$this->form_validation->set_rules('religion', 'Religion', 'trim|required');
$this->form_validation->set_rules('number', 'Mobile.', 'trim|required|min_length[11]|max_length[11]|is_unique[patient_record.pr_number]');
...
$year = date("Y", strtotime("+8 HOURS"));
 ...
 $data = array(
   ...
   'pr_bplace' => $this->input->post('br_place'),
...
$data['topbar'] = 'navbar-default';
    ...
    $this->session->set_flashdata('patientrecord_success', 'Patient Ajouté(e)');
		$this->load->view('layouts/central_template', $data);
...
$this->form_validation->set_rules('lname', 'Nom', 'trim|required|alpha');
$this->form_validation->set_rules('fname', 'Prénom', 'trim|required|alpha');
$this->form_validation->set_rules('middlen', 'Middlename', 'trim|required|alpha');
$this->form_validation->set_rules('address', 'Address', 'required');
$this->form_validation->set_rules('occup', 'Occupation', 'required');
$this->form_validation->set_rules('age', 'Age', 'trim|required|numeric|min_length[2]|max_length[2]');
...
$this->form_validation->set_rules('civilstat', 'Statut', 'trim|required');
$this->form_validation->set_rules('religion', 'Religion', 'trim|required');
$this->form_validation->set_rules('number', 'Mobile.', 'trim|required|min_length[11]|max_length[11]');
...
$this->load->view('layouts/central_template', $data);
 ...
 if($this->Record_model->update_patient_info($pr_id, $data)){
    ...
    $data['main_view'] = 'admission/edit_opd_view';
    $data['pr_id'] = $this->Record_model->get_patient_data($pr_id);
    $this->session->set_flashdata('patientrecord_updated', 'Patient Mis à jour');
...
$this->form_validation->set_rules('e_gen', 'gender', 'trim|required',array('required'=>'Sexe Obligatoire'));
$this->form_validation->set_rules('e_bplace', 'br_place', 'required');
$this->form_validation->set_rules('e_bdate', 'Date of Birth', 'trim|required');
$this->form_validation->set_rules('e_civilstat', 'Statut', 'trim|required');
$this->form_validation->set_rules('e_religion', 'Religion', 'trim|required|alpha');
$this->form_validation->set_rules('e_number', 'Mobile.', 'trim|required|min_length[11]|max_length[11]');
$this->form_validation->set_rules('e_date', 'Date Ajouté(e)', 'trim|required');
...
$this->form_validation->set_rules('a_history', 'Historique de Maladies', 'required');
...
$this->form_validation->set_rules('e_historyillness', 'Historique de Maladies', 'required');
...
$this->form_validation->set_rules('su_user', 'Attending Physician', 'required');
...
$this->form_validation->set_rules('su_user', 'Attending Physician', 'trim|required',array('required'=>'Please select physician'));
...
$data['get_data_admission'] = $this->Record_model->get_data_admission($admission_id);
 ...
 $this->load->view('layouts/central_template', $data);
  ...
  $admission_update_id = $this->Record_model->get_admission_id_update($admission_id);
   ...
   'ad_physician' => $this->input->post('su_user'),
